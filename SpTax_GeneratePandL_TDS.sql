alter Procedure [dbo].[SpTax_GeneratePandL_TDS]                                          
(                                 
...
Where   Security = @sec And Slno = @Sslno                              
 ...
 Delete from #sumtempbal where Trandate>@todate                              
	 ...
	 declare @OtherCharges decimal(10,2);
 ...
 where t.security=s.security  -- to avoid othercharges from sell value
 Insert into tax_Profit_Buynotfound_TDS (Clientid,Trandate,Security,ISIN,Qty,Euser,SellValue)                              
 select @cid,trandate,t.security,s.isinno,balsaleqty,'system',BalSaleValue-@OtherCharges               
 from #sumtempbal t,security s(nolock)                              
 where t.security=s.security              
          -- select * from #sumtempbal           
